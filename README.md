...
> **By tag anyway?** If you must submit an SBOM generated by tag, pass the
> digest-pinned reference as an override so DevRadar can still pin it:
> `make submit SBOM=alpine.cdx.json REF=alpine@$DIGEST`.
...
# list tracked images with finding counts
